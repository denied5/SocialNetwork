        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KnownAs = table.Column<string>(maxLength: 20, nullable: false),
                    Created = table.Column<DateTime>(nullable: false),
                    LastActive = table.Column<DateTime>(nullable: false),
                    Introduction = table.Column<string>(maxLength: 200, nullable: true),
                    LookingFor = table.Column<string>(maxLength: 200, nullable: true),
                    Interests = table.Column<string>(maxLength: 200, nullable: true),
                    City = table.Column<string>(maxLength: 50, nullable: true),
                    Country = table.Column<string>(maxLength: 50, nullable: true),
                    FairbaseToken = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
